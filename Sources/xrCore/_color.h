...
//		a=1.0f-a;
	...
	IC  BOOL	similar_rgba(SelfCRef v, T E= EPS_3) 	const	{ return _abs(r-v.r)<E && _abs(g-v.g)<E && _abs(b-v.b)<E && _abs(a-v.a)<E;};
	IC  BOOL	similar_rgb	(SelfCRef v, T E= EPS_3) 	const	{ return _abs(r-v.r)<E && _abs(g-v.g)<E && _abs(b-v.b)<E;};
};
