...
void CPseudoGigant::on_threaten_execute()
{
	...
	HS.dir				= (fVector3().set(0.0f,1.0f,0.0f));									//	l_P.w_dir	(fVector3().set(0.f,1.f,0.f));
	...
	HS.p_in_bone_space	= (fVector3().set(0.0f,0.0f,0.0f));									//	l_P.w_vec3	(fVector3().set(0.f,0.f,0.f));
