...
public:
			...
			CSE_Abstract						*spawn_item					(LPCSTR section,		const fVector3& position, u32 level_vertex_id, GameGraph::_GRAPH_ID game_vertex_id, u16 parent_id, bool registration = true);
