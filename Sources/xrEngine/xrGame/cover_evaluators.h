...
public:
	...
	IC		void		initialize			(const fVector3& start_position, bool fake_call = false);
	IC		void		setup				(const fVector3& enemy_position, float min_enemy_distance, float	max_enemy_distance, float deviation = 0.f);
...
public:
	...
	IC		void		setup				(const fVector3& enemy_position, float min_enemy_distance, float	max_enemy_distance, u32 level_vertex_id);
