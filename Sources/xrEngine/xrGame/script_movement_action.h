...
public:
	...
	IC				CScriptMovementAction	(MonsterSpace::EBodyState tBodyState, MonsterSpace::EMovementType tMovementType, DetailPathManager::EDetailPathType tPathType, const fVector3& tPosition, float fSpeed = 0.f);
	...
	IC				CScriptMovementAction	(MonsterSpace::EScriptMonsterMoveAction tAct, fVector3& tPosition, float	dist_to_end,							MonsterSpace::EScriptMonsterSpeedParam speed_param);
