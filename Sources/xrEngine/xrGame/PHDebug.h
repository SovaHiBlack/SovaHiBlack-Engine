...
void DBG_DrawRotationX( const fMatrix4x4& m, float ang0, float ang1, float size, u32 ac, bool solid = false, u32 tessel = 7 );
void DBG_DrawRotationY( const fMatrix4x4& m, float ang0, float ang1, float size, u32 ac, bool solid = false, u32 tessel = 7 );
void DBG_DrawRotationZ( const fMatrix4x4& m, float ang0, float ang1, float size, u32 ac, bool solid = false, u32 tessel = 7 );
