...
void CScriptMovementAction::script_register(lua_State *L)
{
	...
	[
		class_<CScriptMovementAction>("move")
			...
			.def(								constructor<MonsterSpace::EBodyState,MonsterSpace::EMovementType,DetailPathManager::EDetailPathType,const fVector3&,float>())
			...
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction, fVector3&, float>())
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction,u32, fVector3&>())
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction,u32, fVector3&, float>())
			...
			.def(								constructor<MonsterSpace::EScriptMonsterMoveAction, fVector3&,			float,	MonsterSpace::EScriptMonsterSpeedParam>())
