...
IC	CScriptSoundAction::CScriptSoundAction		(LPCSTR caSoundToPlay, LPCSTR caBoneName, const fVector3& tPositionOffset, const fVector3& tAngleOffset, bool bLooped, ESoundTypes sound_type)
{
	m_bLooped			= bLooped;
	SetBone				(caBoneName);
...
IC	CScriptSoundAction::CScriptSoundAction		(LPCSTR caSoundToPlay, const fVector3& tPosition, const fVector3& tAngleOffset, bool bLooped, ESoundTypes sound_type)
{
	m_bLooped			= bLooped;
	SetSound			(caSoundToPlay);
...
IC	CScriptSoundAction::CScriptSoundAction		(CScriptSound &sound, LPCSTR caBoneName, const fVector3& tPositionOffset, const fVector3& tAngleOffset, bool bLooped, ESoundTypes sound_type)
{
	m_bLooped			= bLooped;
	SetBone				(caBoneName);
	SetPosition			(tPositionOffset);
...
IC	CScriptSoundAction::CScriptSoundAction		(CScriptSound &sound, const fVector3& tPosition, const fVector3& tAngleOffset, bool bLooped, ESoundTypes sound_type)
{
	m_bLooped			= bLooped;
	SetSound			(sound);
	SetPosition			(tPosition);
...
IC	void CScriptSoundAction::SetPosition		(const fVector3& tPosition)
{
...
IC	void CScriptSoundAction::SetAngles			(const fVector3& tAngles)
{
