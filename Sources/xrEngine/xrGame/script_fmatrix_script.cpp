...
void matrix_transform (Fmatrix* self, fVector3* v)
{
	self->transform (*v);
}
...
void CScriptFmatrix::script_register(lua_State *L)
{
	...
	[
		class_<Fmatrix>("matrix")
			...
			.def("set",							(Fmatrix & (Fmatrix::*)(const fVector3&, const fVector3&, const fVector3&, const fVector3&))(&Fmatrix::set),				return_reference_to(_1))
...
//			.def("translate",					(Fmatrix & (Fmatrix::*)(const fVector3 &))(&Fmatrix::translate),															return_reference_to(_1))
//			.def("translate",					(Fmatrix & (Fmatrix::*)(float, float, float))(&Fmatrix::translate),														return_reference_to(_1))
//			.def("translate_over",				(Fmatrix & (Fmatrix::*)(const fVector3 &))(&Fmatrix::translate_over),														return_reference_to(_1))
...
//			.def("scale",						(Fmatrix & (Fmatrix::*)(const fVector3 &))(&Fmatrix::scale),																return_reference_to(_1))
...
//			.def("rotation",					(Fmatrix & (Fmatrix::*)(const fVector3 &, const fVector3 &))(&Fmatrix::rotation),											return_reference_to(_1))
//			.def("rotation",					(Fmatrix & (Fmatrix::*)(const fVector3 &, float))(&Fmatrix::rotation),													return_reference_to(_1))
...
//			.def("transform_tiny",				(void	   (Fmatrix::*)(fVector3 &) const)(&Fmatrix::transform_tiny),																					out_value(_2))
//			.def("transform_tiny",				(void	   (Fmatrix::*)(fVector3 &, const fVector3 &) const)(&Fmatrix::transform_tiny),																out_value(_2))
//			.def("transform_dir",				(void	   (Fmatrix::*)(fVector3 &) const)(&Fmatrix::transform_dir),																					out_value(_2))
//			.def("transform_dir",				(void	   (Fmatrix::*)(fVector3 &, const fVector3 &) const)(&Fmatrix::transform_dir),																	out_value(_2))
//			.def("transform",					(void	   (Fmatrix::*)(fVector3 &) const)(&Fmatrix::transform),																						out_value(_2))
//			.def("transform",					&matrix_transform)
			.def("setHPB",						&Fmatrix::setHPB,																										return_reference_to(_1))
//			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(fVector3 &))(&Fmatrix::setXYZ),																	return_reference_to(_1)	+	out_value(_2))
			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(float, float, float))(&Fmatrix::setXYZ),															return_reference_to(_1))	 
//			.def("setXYZi",						(Fmatrix & (Fmatrix::*)(fVector3 &))(&Fmatrix::setXYZi),																	return_reference_to(_1) +	out_value(_2))
			.def("setXYZi",						(Fmatrix & (Fmatrix::*)(float, float, float))(&Fmatrix::setXYZi),														return_reference_to(_1))
//			.def("getHPB",						(void	   (Fmatrix::*)(fVector3 &) const)(&Fmatrix::getHPB),																							out_value(_2))
			.def("getHPB",						&get_matrix_hpb)
//			.def("getXYZ",						(void	   (Fmatrix::*)(fVector3 &) const)(&Fmatrix::getXYZ),																							out_value(_2))
//			.def("getXYZ",						(void	   (Fmatrix::*)(float &, float &, float &) const)(&Fmatrix::getXYZ))
//			.def("getXYZi",						(void	   (Fmatrix::*)(fVector3 &) const)(&Fmatrix::getXYZi),																						out_value(_2))
