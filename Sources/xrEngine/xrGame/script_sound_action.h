...
public:
	...
	IC				CScriptSoundAction	(LPCSTR caSoundToPlay, LPCSTR caBoneName, const fVector3& tPositionOffset = fVector3().set(0.0f,0.0f,0.0f), const fVector3& tAngleOffset = fVector3().set(0.0f,0.0f,0.0f), bool bLooped = false, ESoundTypes sound_type = SOUND_TYPE_NO_SOUND);
	IC				CScriptSoundAction	(LPCSTR caSoundToPlay, const fVector3& tPosition, const fVector3& tAngleOffset = fVector3().set(0.0f,0.0f,0.0f), bool bLooped = false, ESoundTypes sound_type = SOUND_TYPE_NO_SOUND);
	IC				CScriptSoundAction	(CScriptSound &sound, LPCSTR caBoneName, const fVector3& tPositionOffset = fVector3().set(0.0f,0.0f,0.0f), const fVector3& tAngleOffset = fVector3().set(0.0f,0.0f,0.0f), bool bLooped = false, ESoundTypes sound_type = SOUND_TYPE_NO_SOUND);
