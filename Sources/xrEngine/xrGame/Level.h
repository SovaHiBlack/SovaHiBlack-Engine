...
public:
	...
	void						g_cl_Spawn				(LPCSTR name, u8 rp, u16 flags, fVector3 pos);	// only ask server
...
public:
	...
	//by Mad Max 
			bool			IsServer					();
			bool			IsClient					();
			CSE_Abstract	*spawn_item					(LPCSTR section, const fVector3& position, u32 level_vertex_id, u16 parent_id, bool return_item = false);
