...
private:
	void				BuildMatrix				(Fmatrix &dest, float invsz, const fVector3& from);
...
public:
	...
	void				AddSkeletonWallmark		(const Fmatrix* xf, CKinematics* obj, ref_shader& sh, const fVector3& start, const fVector3& dir, float size);
